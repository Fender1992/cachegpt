...
export function AuthForm({ isFromCLI = false, callbackPort }: AuthFormProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 sm:px-0">
      {/* Card Container */}
      <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6 sm:p-8 relative">

        {/* Header */}
        <div className="text-center mb-6 sm:mb-8">
          <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-blue-600 rounded-lg flex items-center justify-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                disabled={isLoading}
                className="w-full pl-10 pr-4 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base text-gray-900 placeholder-gray-500"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                disabled={isLoading}
                className="w-full pl-10 pr-12 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base text-gray-900 placeholder-gray-500"
              />
              <button
                type="button"
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 border border-gray-300 rounded-lg hover:border-blue-500 hover:bg-gray-50 transition"
              disabled={isLoading}
            >
        ...
        {isSignUp && (
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row items-center justify-around gap-3 sm:gap-2">
