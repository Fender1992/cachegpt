...
interface YahooPanelProps {
  className?: string;
}

type PanelView = 'labels' | 'messages' | 'message' | 'compose';

export default function YahooPanel({ className }: YahooPanelProps) {
  ...
  if (!yahoo.isPanelOpen) return null;
