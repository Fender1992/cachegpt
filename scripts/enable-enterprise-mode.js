 ...
 * Usage: node scripts/enable-enterprise-mode.js <email>
 */
...
async function enableEnterpriseMode(email) {
  ...
  console.log('   - OpenAI (ChatGPT): sk-proj-...');
  console.log('   - Anthropic (Claude): sk-ant-...');
...
if (!email) {
  console.error('Usage: node scripts/enable-enterprise-mode.js <email>');
  console.error('Example: node scripts/enable-enterprise-mode.js user@example.com');
  process.exit(1);
}

enableEnterpriseMode(email).catch(err => {
