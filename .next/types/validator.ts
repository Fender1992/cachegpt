...
// Validate ../../app/api/admin/check-access/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/check-access">> = Specific
  const handler = {} as typeof import("../../app/api/admin/check-access/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
