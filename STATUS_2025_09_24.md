...
**Latest Update**: PDF Upload Fix with pdf2json
...
- ✅ **Root cause**: Libraries with native dependencies (canvas, node-gyp) can't build in serverless environments
- ✅ **Solution**: Switched to pdf2json, pure JavaScript PDF parser with no native dependencies
- ✅ **File location**: app/api/upload/route.ts:3, 198-236
