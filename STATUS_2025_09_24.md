...
**Latest Update**: Subscription Management on Pricing Page

### What's New in v12.16.0:
1. ✅ **Subscription Management Moved to Pricing Page** (November 24, 2025)
   - Added SubscriptionInfo component to /pricing page
   - Users can now cancel/reactivate subscriptions directly from pricing page
   - Shows for logged-in users with paid subscriptions (Pro, Business, Enterprise)
   - Removed from /settings and /casual-settings pages
   - Centralizes subscription management where users expect it
