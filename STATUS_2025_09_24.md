...
**MAJOR RELEASE**: Phase 0 Complete - Infrastructure for Casual User Experience
...
**Next**: Manual DB migration, then start Phase 1
...
1. **Database Migration**: `034_casual_ui_infrastructure.sql` needs manual application to Supabase
...
- **Phase 1**: Landing page redesign (Hero, TrustBar, FeatureCards, Footer)
- **Phase 2**: Chat UI refresh (Example prompts, voice input, file upload, cache badges)
- **Phase 3**: Modes/Templates API and UI (`GET /api/modes`, `/modes` page)
