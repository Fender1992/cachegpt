...
**Latest Update**: Security Hardening & Anonymous Chat Fix
...
1. ✅ **Security: Removed Console Logging** (November 24, 2025)
   ...
   - Files: app/api/subscription/*, components/settings/subscription-info.tsx, app/api/v2/unified-chat-stream/route.ts
