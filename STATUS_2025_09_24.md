...
**Latest Update**: Subscription Management in Casual Settings

### What's New in v12.16.0:
1. ✅ **Subscription Management UX Improvement** (November 24, 2025)
   - Added SubscriptionInfo component to /casual-settings page
   - Users can now cancel/reactivate subscriptions from main settings (Profile tab)
   - Previously hidden in advanced /settings page, now easily accessible
   - Shows subscription tier, usage, billing date, and cancel/reactivate buttons
   - File: app/casual-settings/page.tsx
