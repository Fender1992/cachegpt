...
export default function Dashboard() {
  ...
  return (
    <>
      {!isDesktopApp && <Navigation />}
      <div className={`${isDesktopApp ? 'min-h-full' : 'min-h-screen'} bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800`}>
