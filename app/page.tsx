      ...
      <nav className="relative z-50 px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className={`flex items-center space-x-1 sm:space-x-2 transition-all duration-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-5'}`}>
            ...
            <span className="hidden sm:inline text-xs text-gray-500 ml-2">v11.2.0</span>
          </div>
            ...
            <div className="bg-gray-900 rounded-lg p-6 mb-6">
              <div className="font-mono space-y-3">
                <div className="flex items-start">
                  ...
                  <span className="text-white">npm install -g cachegpt-cli@latest && cachegpt chat</span>
                </div>
      ...
      <footer className="py-12 px-6 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            ...
            <span className="text-xs ml-1">v11.2.0</span>
          </div>
