...
export default function StatusPageClient() {
  ...
  useEffect(() => {
    checkStatus()
    const interval = autoRefresh ? setInterval(checkStatus, 30000) : null
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">Real-time status of CacheGPT services</p>
              </div>
          ...
          <Card className={`mb-8 border-2 ${
            overallStatus === 'operational' ? 'border-green-500 bg-green-50 dark:bg-green-900/10' :
            overallStatus === 'degraded' ? 'border-yellow-500 bg-yellow-50 dark:bg-yellow-900/10' :
