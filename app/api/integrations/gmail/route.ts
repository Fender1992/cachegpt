/**
 * Gmail Integration Status API
 * GET: Retrieve Gmail integration status
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    if (!integration) {
      return NextResponse.json({ message: 'No Gmail integration found' });
    }
    ...
    return NextResponse.json({ message: 'Gmail integration disconnected' });
  } catch (error) {
